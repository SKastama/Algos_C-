...
class BinarySearchTree {
     ...
     * [25, 15, 10, 4, 12, 22, 18, 24, 50, 35, 31, 44, 35, 70, 66, 90]
     * Time O(n) - Linear, where n = the number of nodes (aka the size) of the tree
     * Space O(n + h) - Linear, where n = the size of the BST (aka how many values are put into
     *              vals), and h = the height of the BST (and by extension, the depth of the 
     *              call stack)
    ...
    toArrPreorder(node = this.root, vals = []) {
        /*
            All 3 of our DFS methods will start with the same edge case:
        ...
        */
        ...
        /*
            We have 3 choices of things to do:
                1. Push the current node's data into vals
                2. Go left
                3. Go right
            
            The order in which we do these things depends entirely on which 
            DFS order we're doing.

            Preorder (this method) wants to handle the current node first, then go left and right,
            so:
        */
        vals.push(node.data);
     ...
     * Example on the fullTree var:
     * [4, 10, 12, 15, 18, 22, 24, 25, 31, 35, 35, 44, 50, 66, 70, 90]
     * Time O(n) - Linear, where n = the number of nodes (aka the size) of the tree
     * Space O(n + h) - Linear, where n = the size of the BST (aka how many values are put into
     *              vals), and h = the height of the BST (and by extension, the depth of the 
     *              call stack) 
    ...
    toArrInorder(node = this.root, vals = []) {
        ...
        /*
            ...
            Inorder (this method) wants to handle the left node first, then the current, and then right,
            so:
        */

        this.toArrInorder(node.left, vals);
        vals.push(node.data);
        return this.toArrInorder(node.right, vals);
    }
     ...
     * Example on the fullTree var:
     * [4, 12, 10, 18, 24, 22, 15, 31, 35, 44, 35, 66, 90, 70, 50, 25]
     * Time O(n) - Linear, where n = the number of nodes (aka the size) of the tree
     * Space O(n + h) - Linear, where n = the size of the BST (aka how many values are put into
     *              vals), and h = the height of the BST (and by extension, the depth of the 
     *              call stack)
    ...
    toArrPostorder(node = this.root, vals = []) {
        ...
        /*
            ...
            Postorder (this method) wants to handle the left node first, then the right, and then current,
            so:
        */
    ...
    toArrLevelorder(current = this.root) { 
        ...
        while (current) {
            ...
            vals.push(current.left.data);
            vals.push(current.right.data);
     ...
     */
    size(node = this.root) { 
        let valsArr= this.toArrPreorder(node.data);
        return Math.ceil((valsArr.length - 1) / 2);
    }
